...
class Gmspay extends PayBase
{
    const PAY_URL = 'https://api.gmspay.net/pay/web';
    const PAYOUT_URL = 'https://api.gmspay.net/pay/transfer';
    ...
    public function getConfig($param)
    {
        ...
        if ($type == 0) {
            return config('pay.gmspay.' . $param);
        }
        return config('pay.gmspay.type.t' . $type . '.' . $param);
    }
