...
class Dzxumpay extends PayBase
{
    const PAY_URL = 'https://payment.dzxum.com/pay/web';
    const PAYOUT_URL = 'https://payment.dzxum.com/pay/transfer';
    ...
    public function getConfig($param)
    {
        ...
        if ($type == 0) {
            return config('pay.dzxumpay.' . $param);
        }
        return config('pay.dzxumpay.type.t' . $type . '.' . $param);
    }
