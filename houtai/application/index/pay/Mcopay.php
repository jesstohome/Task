...
class Mcopay extends PayBase
{
    const PAY_URL = 'https://gateway.mcopay.net/pay/web';
    const PAYOUT_URL = 'https://gateway.mcopay.net/pay/transfer';
    ...
    public function getConfig($param)
    {
        ...
        if ($type == 0) {
            return config('pay.mcopay.' . $param);
        }
        return config('pay.mcopay.type.t' . $type . '.' . $param);
    }
