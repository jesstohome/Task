...
class Kighjpay extends PayBase
{
    const PAY_URL = 'https://ckus.kighj.com/ty/orderPay';
    const PAYOUT_URL = 'https://sekl.kighj.com/withdraw/singleOrder';
    ...
    public function getConfig($param)
    {
        ...
        if ($type == 0) {
            return config('pay.kighjpay.' . $param);
        }
        return config('pay.kighjpay.type.t' . $type . '.' . $param);
    }
