...
class Hooyopay extends PayBase
{
    const PAY_URL = 'https://pay.hooyo.cc/pay/web';
    const PAYOUT_URL = 'https://pay.hooyo.cc/pay/transfer';
    ...
    public function getConfig($param)
    {
        ...
        if ($type == 0) {
            return config('pay.hooyopay.' . $param);
        }
        return config('pay.hooyopay.type.t' . $type . '.' . $param);
    }
